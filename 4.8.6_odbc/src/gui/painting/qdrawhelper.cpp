...
#include <private/inodrawhelper_p.h>
...
static DestFetchProc destFetchProc[QImage::NImageFormats] =
{
    ...
    SPANFUNC_POINTER_DESTFETCH(qrgb888V2),   // Format_RGB888
...
static DestStoreProc destStoreProc[QImage::NImageFormats] =
{
    ...
    SPANFUNC_POINTER_DESTSTORE(qrgb888V2),   // Format_RGB888
...
uint QT_FASTCALL qt_fetchPixel<QImage::Format_RGB888>(const uchar *scanLine,
                                                   ...
                                                   const QVector<QRgb> *)
{
    const qrgb888V2 color = reinterpret_cast<const qrgb888V2*>(scanLine)[x];
    return qt_colorConvert<quint32, qrgb888V2>(color, 0);
}
...
template <>
Q_STATIC_TEMPLATE_SPECIALIZATION
inline quint32 eff_alpha_4(quint32 a, const qrgb888V2*)
{
    return a;
}
...
template <>
Q_STATIC_TEMPLATE_SPECIALIZATION
inline quint32 eff_ialpha_4(quint32 a, const qrgb888V2*)
{
    return ~a;
}
...
template <>
inline void interpolate_pixel_4(qrgb888V2 *dest, const qrgb888V2 *src,
                                quint32 alpha)
{
    Q_ASSERT((quintptr(dest) & 0x3) == 0);
    Q_ASSERT((quintptr(src) & 0x3) == 0);
...
static void blend_untransformed_rgb888V2(int count, const QSpan *spans,
                                       void *userData)
{
    ...
    if (data->texture.format == QImage::Format_RGB888)
        blendUntransformed<qrgb888V2, qrgb888V2>(count, spans, userData);
    else
#endif
...
static void blend_tiled_rgb888V2(int count, const QSpan *spans, void *userData)
{
#if defined(QT_QWS_DEPTH_24)
    QSpanData *data = reinterpret_cast<QSpanData *>(userData);

    if (data->texture.format == QImage::Format_RGB888)
        blendTiled<qrgb888V2, qrgb888V2>(count, spans, userData);
    else
#endif
...
static void blend_transformed_bilinear_rgb888V2(int count, const QSpan *spans, void *userData)
{
#if defined(QT_QWS_DEPTH_24)
    QSpanData *data = reinterpret_cast<QSpanData *>(userData);

    if (data->texture.format == QImage::Format_RGB888)
        blendTransformedBilinear<qrgb888V2, qrgb888V2>(count, spans, userData);
    else
#endif
        blend_src_generic<RegularSpans>(count, spans, userData);
}
...
static void blend_transformed_rgb888V2(int count, const QSpan *spans,
                                     void *userData)
{
#if defined(QT_QWS_DEPTH_24)
    QSpanData *data = reinterpret_cast<QSpanData *>(userData);
    ...
    if (data->texture.format == QImage::Format_RGB888)
        blendTransformed<qrgb888V2, qrgb888V2>(count, spans, userData);
    else
#endif
        blend_src_generic<RegularSpans>(count, spans, userData);
}
...
static void blend_transformed_tiled_rgb888V2(int count, const QSpan *spans,
                                           void *userData)
{
#if defined(QT_QWS_DEPTH_24)
    QSpanData *data = reinterpret_cast<QSpanData *>(userData);
    ...
    if (data->texture.format == QImage::Format_RGB888)
        blendTransformedTiled<qrgb888V2, qrgb888V2>(count, spans, userData);
    else
#endif
        blend_src_generic<RegularSpans>(count, spans, userData);
}
...
static const ProcessSpans processTextureSpans[NBlendTypes][QImage::NImageFormats] = {
     ...
     // TransformedTiled
    {
        ...
        blend_transformed_tiled_rgb888V2,
    ...
    // Bilinear
    {
        ...
        blend_transformed_bilinear_rgb888V2,
...
DrawHelper qDrawHelper[QImage::NImageFormats] =
{
    ...
    // Format_RGB888
    {
        SPANFUNC_POINTER_BLENDCOLOR(qrgb888V2),
        SPANFUNC_POINTER(blend_src_generic, RegularSpans),
        0, 0, 0,
        qt_rectfill_qrgb888V2
    },
    // Format_RGB444
    {
