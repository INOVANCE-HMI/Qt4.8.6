...
#include "inostylesheetstyle_p.h"
...
InoStyleSheetStyle::InoStyleSheetStyle(QStyle *baseStyle)
    : QStyleSheetStyle(baseStyle)
{

}

InoStyleSheetStyle::~InoStyleSheetStyle()
{

}

bool InoStyleSheetStyle::styleSheetPalette(const QWidget *w, const QStyleOption *opt, QPalette *pal)
{
    return QStyleSheetStyle::styleSheetPalette( w, opt, pal );
}
