    ...
    if (encodingsPending && (unsigned)client->bytesAvailable() >=
        ...
        for (int i = 0; i < encodingsPending; ++i) {
            ...
            case Hextile:
                ...
                case 24:
                    encoder = new QRfbHextileEncoder<qrgb888V2>(this);
                    break;
#endif
...
#ifdef QT_QWS_DEPTH_24
        case 24: {
            quint32 p = quint32(*reinterpret_cast<const qrgb888V2*>(src));
            r = qRed(p);
            g = qGreen(p);
            b = qBlue(p);
            src += sizeof(qrgb888V2);
            break;
        }
#endif
        case 32: {
...
#ifdef QT_QWS_DEPTH_24
    case 24:
        d_ptr->dirty = new QVNCDirtyMapOptimized<qrgb888V2>(this);
        break;
#endif
#ifdef QT_QWS_DEPTH_18
    case 18:
